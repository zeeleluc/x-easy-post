<?php
namespace App\Service\Images\MagicPunks;
...
class Regular extends BaseImage
{
    ...
    protected string $project = Projects::MAGIC_PUNKS;

    protected string $name = 'Regular NFT';

    protected string $description = 'This image type gives a regular MagicPunk #ID (or random by property)';
